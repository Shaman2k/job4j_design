...
public class IntervalMergerTest {
    ...
    @Test
    public void whenIntervalsAreNonOverlappingThenReturnSameIntervalsSorted() {
        IntervalMerger intervalMerger = new IntervalMerger();
        int[][] intervals = new int[][]{{1, 4}, {0, 0}};
        int[][] expected = new int[][]{{0, 0}, {1, 4}};
        int[][] result = intervalMerger.merge(intervals);
        assertThat(result).isDeepEqualTo(expected);
    }

    @Test
    public void whenIntervalsFullyOverlapThenMergeIntoLastInterval() {
        IntervalMerger intervalMerger = new IntervalMerger();
        int[][] intervals = new int[][]{{2, 3}, {4, 5}, {8, 9}, {1, 10}};
